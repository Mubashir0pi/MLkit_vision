...
package com.assesment.mlkit.vision.demo
...
import com.assesment.mlkit.vision.demo.kotlin.ChooserActivity
...
class EntryChoiceActivity : AppCompatActivity(), ActivityCompat.OnRequestPermissionsResultCallback {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    findViewById<TextView>(R.id.entry_point).setOnClickListener {
      val intent =
        Intent(
